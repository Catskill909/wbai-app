...
class WBAIColors {
  ...
  // KPFK-style near-black dark mode background (matches the reference screens).
  static const Color trueBlack = Color(0xFF120A07);
}

class AppTheme {
  /// Original light theme: white background, dark brown text/icons.
  ...
  /// True dark theme: near-black KPFK-style background, white text/icons,
  /// blue accent (matches the reference play-button treatment).
  static ThemeData get darkTheme {
    return ThemeData.dark().copyWith(
      scaffoldBackgroundColor: WBAIColors.trueBlack,
      colorScheme: const ColorScheme.dark(
        primary: WBAIColors.blue,
        secondary: WBAIColors.midGray,
        surface: WBAIColors.trueBlack,
        onPrimary: WBAIColors.white,
        onSecondary: WBAIColors.white,
