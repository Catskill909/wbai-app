    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Image.asset(
          ...
          semanticLabel: StreamConstants.stationName,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                height: logoSize,
                                child: Semantics(
                                  button: state.metadata != null,
                                  enabled: state.metadata != null,
                                  label: 'Current show artwork',
                                  hint: state.metadata != null
                                      ? 'Double tap for show details'
                                      : null,
                              ...
                              // NOTE: no inline error card here. Errors are
                              // shown by StreamNoticeModal and nowhere else. An
                              // inline card also sat inside this Column WITHOUT
                              // being counted in spaceLeftForImage above, so
                              // whenever it appeared it pushed the layout and
                              // shrank the station image.
